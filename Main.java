public class Main {
    public static void main(String[] args) {
        ...
        list.add("Wadis", "123", 10, 60);
        list.add("Irfan", "456", 25, 140);
        list.add("Farid", "789", 17, 78);
        list.add("Ocha", "012", 11  , 62);
        list.add("Budi", "345", 5, 35);
        list.add("Kanda", "678", 20, 120);
        list.add("Rayan", "901", 8, 45);
        list.add("Rafi", "234", 22, 127);
        list.add("Asep", "567", 15, 80);
        list.add("Adi", "890", 12, 65);
        list.add("qiqi", "334", 9,  88);
        list.add("intan", "775", 3,  10);
        list.add("yudi", "062", 25,  121);
